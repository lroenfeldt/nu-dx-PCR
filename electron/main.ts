...
import { downloadUpdates, launchUpdates, updater } from "./core/updateManagement";
import { checkResultFileHandler, getResultHandler, getVersion, moveResultFileHandler } from "./core/ipcHandlers";
...
import { endTest, getTests, getUnsubmitted, startTest } from "./core/testManagement";

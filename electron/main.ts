  ...
  defaults: {
    settings: {
      account: {
        ...
        controlSamples: [
          {
            id: "0615d7c3-2e4c-4a80-b1dc-02214aa0a63f",
            name: "POS1",
            label: "TPC1",
            ...
            position96: "B01",
            barcodes: [],
            testTypeId: "305c481b-95de-4c47-8bf2-17d0a23df43f",
            order: 0,
          },
          {
            id: "9cdc8540-fb6b-4a5d-ac81-28d2adaca18d",
            name: "POS2",
            label: "TPC2",
            expectedResult: "positive",
            position16: "A03",
          ...
          {
            id: "dc4f28f5-ddcf-4da5-bf00-16d4d7732c00",
            name: "NTC",
            label: "NTC",

...
const WellVisual: FC<IWellVisualProps> = ({ barcode, active, markActive, showResults = false, testmethod }) => {
	...
	if (showResults && testmethod) {
        ...
        `}
				...
				<div className="spinnerContainer">
					{isNinetySix ? <TailSpin height="40" width="40" color="white" /> : <TailSpin height="70" width="70" color="white" />}
				</div>
			</div>
		);
	}

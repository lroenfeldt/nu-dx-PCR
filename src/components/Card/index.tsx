...
const Card: FC<CardProps> = ({ title, subTitle, durationMinutes, infos, image, onClick, openInfos }) => {
	...
	return (
		<Block width={"368px"} height={"483px"} card>
			...
			<Block inlineFlex column align="flex-start" gap={12}>
				<Text cardTitle>{title.length > 17 ? title.substring(0, 17) + "..." : title}</Text>
				...
				<Block flex width={"368px"} justify="space-between" align="center" padding={24}>

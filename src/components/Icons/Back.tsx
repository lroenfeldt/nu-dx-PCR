...
const Back: FC<IBackProps> = ({ onClick, height = 28, width = 17, color }) => {
	...
	const colorToUse = color ? color : colors.white.focus;
	return (
		<svg onClick={onClick} width={width} height={height} viewBox="0 0 17 28" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
				id="back 1 (Traced)"
				fillRule="evenodd"
				clipRule="evenodd"

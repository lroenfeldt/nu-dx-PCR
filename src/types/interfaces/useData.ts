...
import { IAccount, IDevice, ITestResult, IUserSettings, IAccountUser } from './settings';
...
export interface IUseData {
  ...
  setErrors: React.Dispatch<React.SetStateAction<{ type: string; message: string }[]>>;
  ...
  setParamTrans: React.Dispatch<React.SetStateAction<{ CY5: string; ROX: string }>>;

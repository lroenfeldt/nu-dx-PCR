...
import { ISettings, IAccount, IAccountData, IAccountUser, ITestProcedure, ITestParameterMapping, ITestParameter, ITestResult, IAdditionalAttribute, IDevice, IUserSettings  } from './settings';

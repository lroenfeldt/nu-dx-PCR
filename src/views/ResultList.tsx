...
const ResultList = () => {
	...
	results
		...
		.forEach((result, index) => {
			...
			if (foundTestMethod) {
				if (typeof foundTestMethod[`label${locale.toUpperCase()}` as keyof typeof foundTestMethod] === "string") {
					testMethodName = foundTestMethod[`label${locale.toUpperCase()}` as keyof typeof foundTestMethod] as string;

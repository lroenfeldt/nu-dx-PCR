          ...
          {viewResults === 'table' && (
            <Table
              th={[
                'Position',
                t('common.barcode'),
                ...(testmethod && testmethod.parameters.map((parameter) => {
                        ...
                        <div
                          ...
                          style={{
                            ...
                            backgroundColor: hexToRGB(
                              testmethod &&  testmethod.results.find((result) => result.name.includes(barcode.result))?.color || 'orange',
                              0.1
                            ),
                            minWidth: 114,
                            fontSize: 'small',
                        ...
                        >
                          {
                            barcode.result === 'invalid'
                              ? 'invalid'
                              : (testmethod 
                                  ? testmethod.results.find((result) => result.name.includes(barcode.result))?.['label' + locale?.toUpperCase()]
                                  : undefined

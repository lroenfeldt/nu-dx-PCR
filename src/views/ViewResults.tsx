...
import { Table, Block, Checkmark, Button, RackVisualRows, ChangeResults, AlteredResult, ResultsFooter, Graph, Text } from "../components";
...
const ViewResults: React.FC = () => {
	...
	const { testid, barcodes, settings, testDone, setErrors, setBarcodes, viewType, setViewResults, setSelectedMethod } = useData();
											...
											return [
												...
												testmethod && testmethod.showCurves && (
													<Button bgColor={colors.secondary.main}>
														<Graph onClick={() => navigate(`/viewCurves/${barcode.id}`)} />
													</Button>
												),
											];
										}),
